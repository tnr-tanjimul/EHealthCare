...
namespace EHealthCare.UI_Layer
{
    public partial class PatientDashboard : Form
    {
        ...
        public PatientDashboard(NameValueCollection logData)
        {
            InitializeComponent();
        ...
        {
            OpenFormInPanel(new MedicalHistoryPage(this));
            this.PlainBtnBackColor();
            this.btnMyHistory.BackColor = this.ActiveButtonColor();
        }

        private void btnBpRecords_Click(object sender, EventArgs e)
        {
            OpenFormInPanel(new BPRecordPage(this));
            this.PlainBtnBackColor();
            this.btnBpRecords.BackColor = this.ActiveButtonColor();
        }

        private void btnFeverRecors_Click(object sender, EventArgs e)
        {
            OpenFormInPanel(new FeverReordPage(this));
            this.PlainBtnBackColor();
            this.btnFeverRecors.BackColor = this.ActiveButtonColor();
        }
    }
}
